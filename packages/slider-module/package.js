Package.describe({
  name: 'deligencetechnologies:slidermodule',
  version: '0.0.1',
  // Brief, one-line summary of the package.
  summary: 'Slider Module for PanoplyCMS',
...
Package.onUse(function(api) {
  ...
  api.addFiles('client/addSliderModule.jsx',"client");
  api.addFiles('client/editSliderModule.jsx',"client");
  api.addFiles('server/startup.js',"server");
  api.export(['AddSliderModule', 'EditSliderModule', 'SliderBlock'], "client")
});