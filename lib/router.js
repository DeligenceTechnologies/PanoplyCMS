...
Router.route('/admin/category/:page', {
    name: 'categoryPage',
    template: 'listCategory',
    layoutTemplate: 'adminLayout',
    onBeforeAction: function() {
...
Router.route('/admin/articles/:page', {
    name: 'articlesPage',
...
Router.route('/admin/htmlblocks/1', {
    name: 'htmlblocks',
...
Router.route('/admin/htmlblocks/:page', {
    name: 'htmlblocksPage',
    template: 'listHtmlblocks',
    layoutTemplate: 'adminLayout',
    onBeforeAction: function() {
